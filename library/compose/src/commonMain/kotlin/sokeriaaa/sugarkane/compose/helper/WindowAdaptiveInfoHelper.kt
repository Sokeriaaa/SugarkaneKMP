...
object WindowAdaptiveInfoHelper {

    val WindowAdaptiveInfo.shouldShowNavRail: Boolean
        get() = windowSizeClass.isWidthAtLeastBreakpoint(WindowSizeClass.WIDTH_DP_MEDIUM_LOWER_BOUND)

    val WindowAdaptiveInfo.shouldShowBottomBar: Boolean
        get() = !shouldShowNavRail

    val WindowAdaptiveInfo.isLandscapeMode: Boolean
